...
class WebSocketClient:
    def __init__(self):
        ...
        self.control_parameters = {
            "arm": {"speed": 100, "position": 90},
            "camera": {"angle": 90},
            "motors": {"speed": 100, "direction": "forward"},
            "leds": {"brightness": 50},
        }
        ...
        self.control_status = {
            ...
            "camera": {"tilt_up": False, "tilt_down": False},
            "motors": {
                "forward": False,
                "backward": False,
                "turn_left": False,
            ...
            "leds": {"rainbow": False, "clear": False},
        }
                        ...
                        if "control" in data:
                            ...
                            if control in self.control_mappings:
                                ...
                                if control_function in self.control_functions:
                                    ...
                                    self.control_status[control][control_function] = (
                                        True
                                    )
